...
const SettingsScreen: NavStatelessComponent = () => {
  ...
  const rowItems = [
    ...
    {
      title: "Rizq Home",
      onPress: () => WebBrowser.openBrowserAsync("https://rizq.us/rs/"),
    },
    {
      title: t("SETTINGS_SCREEN_ROADMAP"),
      onPress: () =>
        WebBrowser.openBrowserAsync(
          "https://rizq.us/rs/index-saas.html"
        ),
    },
    {
    ...
    },
    {
      ...
      onPress: () => WebBrowser.openBrowserAsync("https://rizq.us/rizqearth/terms-of-use.pdf"),
    },
    {
